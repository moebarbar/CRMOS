    ...
    <div className="module-head">
      <div>
        ...
        <div className="module-sub">
          {D2.PROPOSALS.length} total · {D2.PROPOSALS.filter((p) => p.status === 'signed').length}{' '}
          signed this month
        </div>
      </div>
      <div className="module-toolbar">
        <button className="btn sm">
          <Icon name="template" size={14} /> Templates
        </button>
            ...
            <div key={p.id} className="tile">
              ...
              <div className="tile-stats">
                <div className="tile-stat">
                  <span>Value</span>
                  <strong className="lime-text">${(p.value / 1000).toFixed(1)}k</strong>
                </div>
                <div className="tile-stat">
                  <span>Sent</span>
                  <strong>{p.sent}</strong>
                </div>
                <div className="tile-stat">
                  <span>Views</span>
...
const ContractsModule = () => {
  const rows = [
    {
      id: 'CTR-088',
      title: 'Acme · Q2 site relaunch · MSA',
      client: 'c1',
      value: 14500,
      signed: 'Apr 26',
      status: 'signed',
      signers: ['You', 'Andy Reeves'],
    },
    {
      id: 'CTR-087',
      title: 'Parallel · Q2 retainer agreement',
      client: 'c7',
      value: 18000,
      signed: 'Apr 1',
      status: 'signed',
    ...
    {
      id: 'CTR-086',
      title: 'Northwind · Annual dev retainer',
      client: 'c2',
      value: 32000,
      signed: 'Mar 10',
      status: 'signed',
      signers: ['You', 'Northwind ops'],
    },
    {
      id: 'CTR-089',
      title: 'Bywater · Brand refresh SOW',
      client: 'c6',
      value: 14500,
      signed: '—',
      status: 'sent',
    ...
    <>
      <div className="module-head">
        <div>
          ...
          <div className="module-sub">
            Multi-party e-signature · audit trail · Yousign passthrough available
          </div>
        </div>
        <div className="module-toolbar">
          <button className="btn sm">
                ...
                <tr key={r.id}>
                  ...
                  <td>
                    <span style={{ display: 'inline-flex', gap: 8, alignItems: 'center' }}>
                      <Avatar name={c.logo} size={20} color={c.color} /> {c.name}
                    </span>
                  </td>
    ...
    <>
      ...
      <div className="module-content">
        <div className="stats-grid" style={{ marginBottom: 16 }}>
          <div className="stat">
            <div className="stat-label">Paid (30d)</div>
            <div className="stat-num lime-text">${(totals.paid / 1000).toFixed(1)}k</div>
            <div className="stat-delta up">
              <Icon name="arrowUp" size={11} /> +18% MoM
            </div>
          </div>
          <div className="stat">
            <div className="stat-label">Overdue</div>
            <div className="stat-num" style={{ color: '#fb7185' }}>
              ${(totals.overdue / 1000).toFixed(1)}k
            </div>
            <div className="stat-delta">3 invoices · Moe chasing</div>
          </div>
          <div className="stat">
            <div className="stat-label">Drafts</div>
            <div className="stat-num">${(totals.draft / 1000).toFixed(1)}k</div>
            <div className="stat-delta">Ready to send</div>
          </div>
          <div className="stat">
            <div className="stat-label">Avg DSO</div>
            <div className="stat-num">14.2d</div>
            <div className="stat-delta up">−2.1d</div>
          </div>
        </div>
        <table className="tbl">
          <thead>
...
const TimeModule = () => {
  ...
  const entries = [
    {
      task: 'Build Acme homepage hero',
      project: 'Acme Q2 relaunch',
      dur: '2:14',
      billable: true,
      day: 'Today',
    },
    {
      task: 'Halstead identity exploration',
      project: 'Halstead identity',
      dur: '1:32',
      billable: true,
      day: 'Today',
    },
    ...
    {
      task: 'Northwind data viz QA',
      project: 'Northwind data viz',
      dur: '3:08',
      billable: true,
      day: 'Yesterday',
    },
    {
      task: 'Stella site map review',
      project: 'Stella campaign site',
      dur: '1:45',
      billable: true,
      day: 'Yesterday',
    },
    {
      task: 'Acme client call',
      project: 'Acme Q2 relaunch',
      dur: '0:42',
      billable: true,
      day: 'Yesterday',
    ...
    <>
      <div className="module-head">
        <div>
          ...
          <div className="module-sub">
            This week: 28h 12m · 24h 18m billable · $4,860 to invoice
          </div>
        </div>
        <div className="module-toolbar">
          <button className="btn sm">
            <Icon name="download" size={14} /> Export timesheet
          </button>
          <button className="btn primary sm">
            <Icon name="invoice" size={14} /> Bill the hours
          </button>
        </div>
      </div>
      <div className="module-content">
          ...
          <tbody>
            {entries.map((e, i) => (
              <tr key={i}>
                ...
                <td>
                  {e.billable ? (
                    <span className="lime-text mono">●</span>
                  ) : (
    ...
    <>
      <div className="module-head">
        <div>
          ...
          <div className="module-sub">
            3 booking pages · 142 bookings this month · round-robin enabled
          </div>
        </div>
        <div className="module-toolbar">
          <button className="btn sm">
          ...
          <div key={f.id} className="form-tile">
            ...
            <div className="form-tile-body">
              ...
              <div
                ...
                style={{ paddingTop: 10, marginTop: 0, borderTop: 'none' }}
              >
                <div className="tile-stat">
                  <span>Subs</span>
                  <strong>{f.subs}</strong>
                </div>
                <div className="tile-stat">
                  <span>Conv</span>
                  <strong>{f.conv}%</strong>
                </div>
                <div className="tile-stat">
                  <span>Last</span>
...
const PortalModule = () => (
  <>
    <div className="module-head">
      ...
      <div className="module-toolbar">
        <button className="btn sm">
          <Icon name="settings" size={14} /> Branding
        </button>
        <button className="btn sm">
          <Icon name="globe" size={14} /> Domain
        </button>
        <button className="btn primary sm">
          <Icon name="eye" size={14} /> Preview as client
        </button>
      </div>
    </div>
    <div className="module-content">
          ...
          <div className="portal-hero">
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 13, color: 'var(--text-2)' }}>
                Your Q2 site relaunch is 64% complete · launch May 18
              </div>
            </div>
            <button className="btn primary sm">
              View project <Icon name="arrow" size={12} />
            </button>
          </div>
            ...
            <div className="portal-section">
              ...
              <div className="card" style={{ padding: 16 }}>
                ...
                <div className="project-progress-track">
                  <div className="project-progress-fill" style={{ width: '64%' }} />
                </div>
                <div
                  style={{
                    fontSize: 11,
        ...
        {automations.map((a) => (
          <div key={a.id} className="auto-row">
            <div className="auto-icon">
              <Icon name="workflow" size={16} stroke="var(--lime)" />
            </div>
            <div>
            ...
            <div
              ...
              onClick={() =>
                setAutomations(automations.map((x) => (x.id === a.id ? { ...x, on: !x.on } : x)))
              }
            />
