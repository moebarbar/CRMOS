// Moe — agentic AI face icon
// Friendly two-eyed operator. Theme-aware face color, high-contrast eyes,
// expressive states: idle, listening, thinking, speaking.

const MoeIcon = ({ size = 48, state = 'idle', accent = 'var(--lime)' }) => {
  ...
  // Thinking = bigger, faster glances; otherwise gentle idle wander.
  React.useEffect(() => {
  ...
  // Suppress unused-var warnings on isListening for tidy diff
  void isListening;

  // Face fill: tinted accent so it reads in both dark and light modes
  // and remains recognizable as "Moe" — a colorful character, not a black blob
